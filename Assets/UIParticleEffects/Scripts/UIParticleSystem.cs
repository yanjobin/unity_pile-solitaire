...
public class UIParticleSystem : MonoBehaviour {
    ...
    /// Color Over Lifetime
    /// </summary>
    public List<Gradient> ColorOverLifetime;
    ...
    private IEnumerator CoParticleFly(Image particle)
    {
        ...
        int randomColor = Random.Range(0, ColorOverLifetime.Count);
        ...
        while (particleLifetime < Lifetime)
        {
            ...
            //set color
            particle.color = ColorOverLifetime[randomColor].Evaluate(particleLifetime / Lifetime);
